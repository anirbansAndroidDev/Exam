...
public class ClassResult extends ActivityGroup implements ViewFactory {
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				if (date instanceof TextView && !date.getText().equals("")) {
					...
					if (lstScheduleList != null && lstScheduleList.size() > 0) {
						...
						AlertDialog.Builder adLevel = new Builder(CurContextNew);
...
//	}
	...
	private void PracticeExamDownloader() {
		...
		adStartExam = null;
		adStartExam = new Builder(CurContextNew);
...
//			replaceView(DownlaodMockview);
			...
			Toast.makeText(CurContextNew, e.getMessage(),Toast.LENGTH_LONG).show();
		}
	}
